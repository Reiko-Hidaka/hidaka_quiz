...
class QuizApp(tk.Tk):
    ...
    def show_image_after_quiz(self, photo_file=None):
        if photo_file:
            ...
            next_button = tk.Button(image_window,text="次のクイズに進む", command=close_image_window)
            next_button.pack()
